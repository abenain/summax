...
export function ControlBar({ disabled = false, durationMs = 0, isFullscreen, isPlaying, onFullscreenButtonPress = NoOp, onPlayPauseButtonPress = NoOp, positionMs = 0 }: Props) {
  return (
